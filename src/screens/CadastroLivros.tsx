...
const CadastroLivros: React.FC = () => {
    ...
    const [autorErro, setAutorErro] = useState<string>('');
    const [generoErro, setGeneroErro] = useState<string>('');
    const [data_de_lancamentoErro, setDataDeLancamentoErro] = useState<string>('');
    const [editoraErro, setEditoraErro] = useState<string>('');
    const [sinopseErro, setSinopseErro] = useState<string>('');
    const [avaliacaoErro, setAvaliacaoErro] = useState<string>('');
